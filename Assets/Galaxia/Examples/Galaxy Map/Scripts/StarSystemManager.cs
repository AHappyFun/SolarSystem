...
public class StarSystemManager : MonoBehaviour {
    ...
    void Start()
    {
        ...
        for (int i = 0; i < Stars.Count;i++ )
        {
            ...
            if(starSystem.Name == "太阳系")
            {
                starSystem.Planets = 8;
            }
    ...
    {
        "Albireo","Cygnus X-1","16 Cygni","Kelu-1","Pismis 24-1","Castor","40 Eridani","Polaris","太阳系","TV Crateris","Alpha Centauri","Anus","Avalon","Darwin IV","Far Away","Gaia","Gor","Hydros",
